...
class Franka(Robot):
    ...
    def initialize(self):
        ...
        self.keyboard_controller = self._backends[0]
        self.keyboard_controller.update_state(self.ee_state.link_child_global_state)
    ...
    def step(self):
        ...
        if self.keyboard_controller.running:
            self.target_pos, self.target_quat, self.target_handopen = self.keyboard_controller.step(None)
